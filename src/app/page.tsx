...
export default async function Home() {
  return <div className="z-10 w-full items-start justify-between text-sm lg:flex">
    ...
    <div className="mt-4 ml-4">
      <p className="font-bold mb-4">Wir haben ein Plattenlabel gegründet. Es trägt den Namen Hobbymusik. Hier kommen einige Gründe dafür.</p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        <Link className="font-bold" href="/guidelines">-&gt; Zu unseren Guidelines</Link>
      </p>
    </div>
  </div>
}
