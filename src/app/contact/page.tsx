export default function Contact() {
  return <div>
    <div className="m-8 lg:mx-0">
      ...
      <p className="mb-4">
        Vielleicht bist du oder Künstler*innen, die du kennst, auch an einer
        Zusammenarbeit mit uns interessiert? Wenn dir unser Konzept gefällt und du
        meinst, dass wir zusammen passen könnten, schreibe uns auch und füge am besten
