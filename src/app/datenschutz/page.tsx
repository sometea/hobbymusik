export default function Datenschutz() {
  ...
  <h3 className="text-xl uppercase my-2">DATENERFASSUNG AUF DIESER WEBSITE</h3>
  <h3 className="text-xl uppercase my-2">WER IST VERANTWORTLICH FÜR DIE DATENERFASSUNG AUF DIESER WEBSITE?</h3>
  Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen Kontaktdaten können Sie dem Abschnitt „Hinweis zur Verantwortlichen Stelle“ in dieser Datenschutzerklärung entnehmen.

  <h3 className="text-xl uppercase my-2">WIE ERFASSEN WIR IHRE DATEN?</h3>
  Ihre Daten werden zum einen dadurch erhoben, dass Sie uns diese mitteilen. Hierbei kann es sich z. B. um Daten handeln, die Sie in ein Kontaktformular eingeben.

  Andere Daten werden automatisch oder nach Ihrer Einwilligung beim Besuch der Website durch unsere IT-Systeme erfasst. Das sind vor allem technische Daten (z. B. Internetbrowser, Betriebssystem oder Uhrzeit des Seitenaufrufs). Die Erfassung dieser Daten erfolgt automatisch, sobald Sie diese Website betreten.

  <h3 className="text-xl uppercase my-2">WOFÜR NUTZEN WIR IHRE DATEN?</h3>
  Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gewährleisten. Andere
  Daten können zur Analyse Ihres Nutzerverhaltens verwendet werden.



  <h3 className="text-xl uppercase my-2">WELCHE RECHTE HABEN SIE BEZÜGLICH IHRER DATEN?</h3>
  ...
  <h3 className="text-xl uppercase my-2">ANALYSE-TOOLS UND TOOLS VON DRITTANBIETERN</h3>
  ...
  Anbieter ist die BunnyWay d.o.o., Dunajska cesta 165, 1000 Ljubljana, Slovenia (nachfolgend Bunny oder auch Bunny.net). Wenn Sie unsere Website besuchen, erfasst Bunny verschiedene Logfiles inklusive Ihrer IP-Adressen. Details entnehmen Sie der Datenschutzerklärung von Bunny: https://bunny.net/privacy/.
  ...
  <h2 className="text-xl uppercase my-2">3. ALLGEMEINE HINWEISE UND PFLICHTINFORMATIONEN</h2>
  <h3 className="text-xl uppercase my-2">DATENSCHUTZ</h3>
  ...
  <h3 className="text-xl uppercase my-2">SPEICHERDAUER</h3>
  Soweit innerhalb dieser Datenschutzerklärung keine speziellere Speicherdauer genannt wurde, verbleiben Ihre personenbezogenen Daten bei uns, bis der Zweck für die Datenverarbeitung entfällt. Wenn Sie ein berechtigtes Löschersuchen geltend machen oder eine Einwilligung zur Datenverarbeitung widerrufen, werden Ihre Daten gelöscht, sofern wir keine anderen rechtlich zulässigen Gründe für die Speicherung Ihrer personenbezogenen Daten haben (z. B. steuer- oder handelsrechtliche Aufbewahrungsfristen); im letztgenannten Fall erfolgt die Löschung nach Fortfall dieser Gründe.

  <h3 className="text-xl uppercase my-2">ALLGEMEINE HINWEISE ZU DEN RECHTSGRUNDLAGEN DER DATENVERARBEITUNG AUF DIESER WEBSITE</h3>
  ...
  <h3 className="text-xl uppercase my-2">HINWEIS ZUR DATENWEITERGABE IN DIE USA UND SONSTIGE DRITTSTAATEN</h3>
  Wir verwenden unter anderem Tools von Unternehmen mit Sitz in den USA oder sonstigen datenschutzrechtlich nicht sicheren Drittstaaten. Wenn diese Tools aktiv sind, können Ihre
  ...
  <h3 className="text-xl uppercase my-2">WIDERRUF IHRER EINWILLIGUNG ZUR DATENVERARBEITUNG</h3>
  ...
  <h3 className="text-xl uppercase my-2">BESCHWERDERECHT BEI DER ZUSTÄNDIGEN AUFSICHTSBEHÖRDE</h3>
  Im Falle von Verstößen gegen die DSGVO steht den Betroffenen ein Beschwerderecht bei einer Aufsichtsbehörde, insbesondere in dem Mitgliedstaat ihres gewöhnlichen Aufenthalts, ihres Arbeitsplatzes oder des Orts des mutmaßlichen Verstoßes zu. Das Beschwerderecht besteht unbeschadet anderweitiger verwaltungsrechtlicher oder gerichtlicher Rechtsbehelfe.

  <h3 className="text-xl uppercase my-2">RECHT AUF DATENÜBERTRAGBARKEIT</h3>
  Sie haben das Recht, Daten, die wir auf Grundlage Ihrer Einwilligung oder in Erfüllung eines Vertrags automatisiert verarbeiten, an sich oder an einen Dritten in einem gängigen, maschinenlesbaren Format aushändigen zu lassen. Sofern Sie die direkte Übertragung der Daten an einen anderen Verantwortlichen verlangen, erfolgt dies nur, soweit es technisch machbar ist.

  <h3 className="text-xl uppercase my-2">AUSKUNFT, BERICHTIGUNG UND LÖSCHUNG</h3>
  Sie haben im Rahmen der geltenden gesetzlichen Bestimmungen jederzeit das Recht auf unentgeltliche Auskunft über Ihre gespeicherten personenbezogenen Daten, deren Herkunft und Empfänger und den Zweck der Datenverarbeitung und ggf. ein Recht auf Berichtigung oder Löschung dieser Daten. Hierzu sowie zu weiteren Fragen zum Thema personenbezogene Daten können Sie sich jederzeit an uns wenden.

  <h3 className="text-xl uppercase my-2">RECHT AUF EINSCHRÄNKUNG DER VERARBEITUNG</h3>
  ...
  <h3 className="text-xl uppercase my-2">SSL- BZW. TLS-VERSCHLÜSSELUNG</h3>
  Diese Seite nutzt aus Sicherheitsgründen und zum Schutz der Übertragung vertraulicher Inhalte, wie zum Beispiel Bestellungen oder Anfragen, die Sie an uns als Seitenbetreiber senden, eine SSL- bzw. TLS- Verschlüsselung. Eine verschlüsselte Verbindung erkennen Sie daran, dass die Adresszeile des Browsers von „http://“ auf „https://“ wechselt und an dem Schloss-Symbol in Ihrer Browserzeile. Wenn die SSL- bzw. TLS-Verschlüsselung aktiviert ist, können die Daten, die Sie an uns übermitteln, nicht von Dritten mitgelesen werden.



  <h2 className="text-xl uppercase my-2">4. DATENERFASSUNG AUF DIESER WEBSITE</h2>
  <h3 className="text-xl uppercase my-2">COOKIES</h3>
  ...
  Drittunternehmen innerhalb von Webseiten (z. B. Cookies zur Abwicklung von Zahlungsdienstleistungen). Cookies haben verschiedene Funktionen. Zahlreiche Cookies sind technisch notwendig, da bestimmte Webseitenfunktionen ohne diese nicht funktionieren würden (z. B. die Warenkorbfunktion oder die Anzeige von Videos). Andere Cookies können zur Auswertung des Nutzerverhaltens oder zu Werbezwecken verwendet werden. Cookies, die zur Durchführung des elektronischen Kommunikationsvorgangs, zur Bereitstellung bestimmter, von Ihnen erwünschter Funktionen (z. B. für die Warenkorbfunktion) oder zur Optimierung der Website (z. B. Cookies zur Messung des Webpublikums) erforderlich sind (notwendige Cookies), werden auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO gespeichert, sofern keine andere Rechtsgrundlage angegeben wird. Der Websitebetreiber hat ein berechtigtes Interesse an der Speicherung von notwendigen Cookies zur technisch fehlerfreien und optimierten Bereitstellung seiner Dienste. Sofern eine Einwilligung zur Speicherung von Cookies und vergleichbaren Wiedererkennungstechnologien abgefragt wurde, erfolgt die Verarbeitung ausschließlich auf Grundlage dieser Einwilligung (Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TTDSG); die Einwilligung ist jederzeit widerrufbar. Sie können Ihren Browser so einstellen, dass Sie über das Setzen von Cookies informiert werden und Cookies nur im Einzelfall erlauben, die Annahme von Cookies für bestimmte Fälle oder generell ausschließen
  sowie das automatische Löschen der Cookies beim Schließen des Browsers aktivieren. Bei der Deaktivierung von Cookies kann die Funktionalität dieser Website eingeschränkt sein. Welche Cookies und Dienste auf dieser Website eingesetzt werden, können Sie dieser Datenschutzerklärung entnehmen.

  <h2 className="text-xl uppercase my-2">5. STATISTISCHE AUSWERTUNG DER BESUCHE DIESER INTERNETSEITE</h2>
  <h3 className="text-xl uppercase my-2">GOOGLE TAG MANAGER</h3>
  ...
  <h3 className="text-xl uppercase my-2">GOOGLE-ANALYTICS</h3>
